...
const styles = StyleSheet.create({
  ...
  otpCard:            {
    backgroundColor: Colors.white, marginHorizontal: 16, marginBottom: 12, borderRadius: 16, padding: 20,
    borderWidth: 2, borderColor: Colors.primary + '30',
    shadowColor: Colors.primary, shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 8, elevation: 3,
  },
  otpHeader:          { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 16 },
  otpTitle:           { fontSize: 16, fontWeight: '700', color: Colors.primary },
  otpCodeRow:         { flexDirection: 'row', gap: 8, justifyContent: 'center', marginBottom: 12 },
  otpDigitBox:        {
    width: 44, height: 52, borderRadius: 12, backgroundColor: '#FFF3EE',
